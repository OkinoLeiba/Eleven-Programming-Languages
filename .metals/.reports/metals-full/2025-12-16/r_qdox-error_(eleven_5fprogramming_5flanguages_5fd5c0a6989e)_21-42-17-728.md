error id: file://<WORKSPACE>/CoffeeTest.java
file://<WORKSPACE>/CoffeeTest.java
...
```java
offset: 3
uri: file://<WORKSPACE>/CoffeeTest.java
text:
```scala

p@@ackage com.sun.org
...
QDox parse error in file://<WORKSPACE>/CoffeeTest.java